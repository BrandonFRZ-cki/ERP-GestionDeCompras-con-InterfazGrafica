...
public class ShowConsole {
    ...
    public int showMenuPrincipal() {
        ...
        System.out.println("4.  Listado Proveedores");
        System.out.println("5.  Listado Productos");
        System.out.println("6.  Listado Solicitud de compra");
        System.out.println("7.  Busqueda Proveedor por ID");
        System.out.println("8.  Busqueda Producto por nombre");
        System.out.println("9.  Busqueda Solicitud por numero");
        System.out.println("10. Aprobacion / Rechazar Solicitud de compra");
